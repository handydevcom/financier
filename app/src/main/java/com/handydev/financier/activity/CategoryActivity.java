...
import static com.handydev.financier.activity.CategorySelector.SelectorType.PARENT;
import static com.handydev.financier.activity.RequestPermission.isRequestingPermission;
import static com.handydev.financier.utils.Utils.checkEditText;
import static com.handydev.financier.utils.Utils.text;
    ...
    protected void onClick(final View v, final int id) {
        switch (id) {
            ...
            case R.id.category_show_filter:
                parentCatSelector.onClick(R.id.category_show_filter);
                break;
            case R.id.category_close_filter:
                parentCatSelector.onClick(R.id.category_close_filter);
                break;
            case R.id.category_show_list:
                parentCatSelector.onClick(R.id.category_show_list);
                break;
