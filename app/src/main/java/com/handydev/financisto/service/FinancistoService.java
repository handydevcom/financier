 ...
 ******************************************************************************/
package com.handydev.financisto.service;
...
import com.handydev.financisto.activity.AbstractTransactionActivity;
import com.handydev.financisto.activity.AccountWidget;
import com.handydev.financisto.activity.MassOpActivity;
...
import com.handydev.financisto.model.Transaction;
import com.handydev.financisto.model.TransactionInfo;
import com.handydev.financisto.model.TransactionStatus;
import com.handydev.financisto.recur.NotificationOptions;
import static com.handydev.financisto.service.DailyAutoBackupScheduler.scheduleNextAutoBackup;
import static com.handydev.financisto.service.SmsReceiver.SMS_TRANSACTION_BODY;
import static com.handydev.financisto.service.SmsReceiver.SMS_TRANSACTION_NUMBER;
import com.handydev.financisto.utils.MyPreferences;
import static com.handydev.financisto.utils.MyPreferences.getSmsTransactionStatus;
import static com.handydev.financisto.utils.MyPreferences.shouldSaveSmsToTransactionNote;
